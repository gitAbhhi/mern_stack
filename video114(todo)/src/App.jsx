    ...
    <>
      ...
      <div className="container m-auto md:w-[70%]  my-5 rounded-3xl p-5 bg-violet-100">
        ...
        <div>
          ...
          <input onChange={handlechange} value={todo} className='w-[85%] h-11 my-3 rounded-full p-3' type="text" placeholder='Write your task' />
          <button onClick={handleadd} disabled={todo.length<=3} className='bg-violet-700 text-white text-xl font-bold rounded-full w-[10%] h-11 m-3 items-center'>Save</button>
          <div>
        ...
        <div className="todos">
          ...
          {todos.map(item=>{
          return (showfinished|| !item.isCompleted)&& <div key={item.id} className="{todo flex items-center w-1/4 justify-between my-3}">
